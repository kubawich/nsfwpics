function updateImageDisplay(){for(var n,f,t,i,r,e,u;preview.firstChild;)preview.removeChild(preview.firstChild);if(n=input.files,n.length===0)console.log("empty");else for(f=document.createElement("ol"),preview.appendChild(f),t=0;t<n.length;t++)i=document.createElement("li"),r=document.createElement("p"),validFileType(n[t])?(r.textContent="File name "+n[t].name+", file size "+returnFileSize(n[t].size)+".",e=document.createElement("img"),size=n[t].size,e.src=window.URL.createObjectURL(n[t]),i.appendChild(e),i.appendChild(r)):validVideoType(n[t])?(r.textContent="File name "+n[t].name+", file size "+returnFileSize(n[t].size)+".",u=document.createElement("video"),size=n[t].size,u.setAttribute("autoplay",!0),u.src=window.URL.createObjectURL(n[t]),i.appendChild(u),i.appendChild(r)):(para.textContent="File name "+n[t].name+": Not a valid file type. Update your selection.",i.appendChild(r)),f.appendChild(i)}function validFileType(n){for(var t=0;t<fileTypes.length;t++)if(n.type===fileTypes[t])return!0;return!1}function validVideoType(n){for(var t=0;t<videoTypes.length;t++)if(n.type===videoTypes[t])return!0;return!1}function returnFileSize(n){return n<1024?n+"bytes":n>1024&&n<1048576?(n/1024).toFixed(1)+"KB":n>1048576?(n/1048576).toFixed(1)+"MB":void 0}function showUpload(){if(size<=1e7){let t=document.getElementById("img_load");var n='<blockquote id="waitquote" style="font-weight:bold; color:black;">Wait until file\'s uploaded, it may take some time, dependent on your bandwith<\/blockquote><div class="progress" style="border-radius:10px; margin:1.5rem 0 1rem 0; height:7px;" id="preloader"><br /><br /><div class="indeterminate" id="preloader_bar" style="background-color:#42a5f5;"><\/div>';t.innerHTML=n;let i=document.getElementById("upload_button"),r=document.getElementById("file_button");setTimeout(function(){i.style.display="none";r.style.display="none"},130)}else alert("File's too big, max upload size is 10MBs")}function getCookie(n){for(var t,r=n+"=",f=decodeURIComponent(document.cookie),u=f.split(";"),i=0;i<u.length;i++){for(t=u[i];t.charAt(0)==" ";)t=t.substring(1);if(t.indexOf(r)==0)return t.substring(r.length,t.length)}return""}function setCookie(n,t,i){var r=new Date,u;r.setTime(r.getTime()+i*864e5);u="expires="+r.toUTCString();document.cookie=n+"="+t+";"+u+";path=/"}function delCookie(n){document.cookie=`${n}=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;`;console.log(`Deleted cookie ${n}`)}function getCookie(n){for(var t,r=n+"=",f=decodeURIComponent(document.cookie),u=f.split(";"),i=0;i<u.length;i++){for(t=u[i];t.charAt(0)==" ";)t=t.substring(1);if(t.indexOf(r)==0)return t.substring(r.length,t.length)}return""}function removePlus(){document.querySelectorAll("button").forEach(n=>n.remove())}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function plus(n){if(localStorage.getItem(`${n}`)==`true`){let t=parseInt(document.getElementById(`points_${n}`).innerHTML);document.getElementById(`points_${n}`).innerHTML=t-1;fetch(`https://nsfwpics.pw/api/minus/${n}`).then(function(n){return n.json()});localStorage.removeItem(`${n}`)}else{localStorage.setItem(`${n}`,`true`);let t=parseInt(document.getElementById(`points_${n}`).innerHTML);document.getElementById(`points_${n}`).innerHTML=t+1;fetch(`https://nsfwpics.pw/api/plus/${n}`).then(function(n){return n.json()})}}function setIndexViewType(n){parseInt(n)==0?(delCookie("viewType"),location.reload()):parseInt(n)==1?(setCookie("viewType","images"),location.reload()):(setCookie("viewType","videos"),location.reload())}function ChangeSite(n){var t,i;n==""?(t=document.getElementById("siteMain"),i=document.getElementById("siteMainBig"),t.checked=!0,i.checked=!0,setCookie("site","main",0),window.location.replace("https://nsfwpics.pw/")):n=="queue"?(t=document.getElementById("siteQueue"),i=document.getElementById("siteQueueBig"),t.checked=!0,i.checked=!0,setCookie("site","queue",0),window.location.replace("https://nsfwpics.pw/queue")):(t=document.getElementById("siteMain"),i=document.getElementById("siteMainBig"),t.checked=!0,i.checked=!0,setCookie("site","main",0),window.location.replace("https://nsfwpics.pw/"))}function autoplayVideo(n){document.getElementById(`${n}`).play()}var input=document.querySelector(".input"),preview=document.querySelector(".preview"),size=null,fileTypes,videoTypes,logins,i,d,_createClass,getTime,Vel,navButton,navButtonBig,radio,radioBig;input.addEventListener("change",updateImageDisplay);fileTypes=["image/jpeg","image/pjpeg","image/png",];videoTypes=["video/mp4","video/webm"];const upload=(()=>{var t=document.querySelector(".input"),n=new FormData;return n.append("",t.files[0]),fetch("https://nsfwpics.pw/api/add",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n}).then(n=>n.json()).then(n=>alert(n)).then(n=>console.log(n)).catch(n=>console.log(n))})(function(n,t){"function"==typeof define&&define.amd?define(t):"object"==typeof exports?module.exports=t():n.Blazy=t()})(this,function(){function h(n){var i=n._util;i.elements=b(n.options);i.count=i.elements.length;i.destroyed&&(i.destroyed=!1,n.options.container&&t(n.options.container,function(n){r(n,"scroll",i.validateT)}),r(window,"resize",i.saveViewportOffsetT),r(window,"resize",i.validateT),r(window,"scroll",i.validateT));c(n)}function c(n){for(var s,r,t,h,f=n._util,o=0;o<f.count;o++){s=f.elements[o];n:{if(t=s,r=n.options,h=t.getBoundingClientRect(),r.container&&w&&(t=t.closest(r.containerClass))){t=t.getBoundingClientRect();r=u(t,i)?u(h,{top:t.top-r.offset,right:t.right+r.offset,bottom:t.bottom+r.offset,left:t.left-r.offset}):!1;break n}r=u(h,i)}(r||e(s,n.options.successClass))&&(n.load(s),f.elements.splice(o,1),f.count--,o--)}0===f.count&&n.destroy()}function u(n,t){return n.right>=t.left&&n.bottom>=t.top&&n.left<=t.right&&n.top<=t.bottom}function l(i,u,h){if(!e(i,h.successClass)&&(u||h.loadInvisible||0<i.offsetWidth&&0<i.offsetHeight))if(u=i.getAttribute(s)||i.getAttribute(h.src)){u=u.split(h.separator);var l=u[p&&1<u.length?1:0],w=i.getAttribute(h.srcset),b="img"===i.nodeName.toLowerCase(),k=(u=i.parentNode)&&"picture"===u.nodeName.toLowerCase();if(b||void 0===i.src){var c=new Image,v=function(){h.error&&h.error(i,"invalid");o(i,h.errorClass);n(c,"error",v);n(c,"load",y)},y=function(){b?k||a(i,l,w):i.style.backgroundImage='url("'+l+'")';f(i,h);n(c,"load",y);n(c,"error",v)};k&&(c=i,t(u.getElementsByTagName("source"),function(n){var t=h.srcset,i=n.getAttribute(t);i&&(n.setAttribute("srcset",i),n.removeAttribute(t))}));r(c,"error",v);r(c,"load",y);a(c,l,w)}else i.src=l,f(i,h)}else"video"===i.nodeName.toLowerCase()?(t(i.getElementsByTagName("source"),function(n){var t=h.src,i=n.getAttribute(t);i&&(n.setAttribute("src",i),n.removeAttribute(t))}),i.load(),f(i,h)):(h.error&&h.error(i,"missing"),o(i,h.errorClass))}function f(n,i){o(n,i.successClass);i.success&&i.success(n);n.removeAttribute(i.src);n.removeAttribute(i.srcset);t(i.breakpoints,function(t){n.removeAttribute(t.src)})}function a(n,t,i){i&&n.setAttribute("srcset",i);n.src=t}function e(n,t){return-1!==(" "+n.className+" ").indexOf(" "+t+" ")}function o(n,t){e(n,t)||(n.className+=" "+t)}function b(n){var i=[],t;for(n=n.root.querySelectorAll(n.selector),t=n.length;t--;i.unshift(n[t]));return i}function v(n){i.bottom=(window.innerHeight||document.documentElement.clientHeight)+n;i.right=(window.innerWidth||document.documentElement.clientWidth)+n}function r(n,t,i){n.attachEvent?n.attachEvent&&n.attachEvent("on"+t,i):n.addEventListener(t,i,{capture:!1,passive:!0})}function n(n,t,i){n.detachEvent?n.detachEvent&&n.detachEvent("on"+t,i):n.removeEventListener(t,i,{capture:!1,passive:!0})}function t(n,t){if(n&&t)for(var r=n.length,i=0;i<r&&!1!==t(n[i],i);i++);}function y(n,t,i){var r=0;return function(){var u=+new Date;u-r<t||(r=u,n.apply(i,arguments))}}var s,i,p,w;return function(r){var e,u,f;document.querySelectorAll||(e=document.createStyleSheet(),document.querySelectorAll=function(n,t,i,r,u){for(u=document.all,t=[],n=n.replace(/\[for\b/gi,"[htmlFor").split(","),i=n.length;i--;){for(e.addRule(n[i],"k:v"),r=u.length;r--;)u[r].currentStyle.k&&t.push(u[r]);e.removeRule(0)}return t});u=this;f=u._util={};f.elements=[];f.destroyed=!0;u.options=r||{};u.options.error=u.options.error||!1;u.options.offset=u.options.offset||100;u.options.root=u.options.root||document;u.options.success=u.options.success||!1;u.options.selector=u.options.selector||".b-lazy";u.options.separator=u.options.separator||"|";u.options.containerClass=u.options.container;u.options.container=u.options.containerClass?document.querySelectorAll(u.options.containerClass):!1;u.options.errorClass=u.options.errorClass||"b-error";u.options.breakpoints=u.options.breakpoints||!1;u.options.loadInvisible=u.options.loadInvisible||!1;u.options.successClass=u.options.successClass||"b-loaded";u.options.validateDelay=u.options.validateDelay||25;u.options.saveViewportOffsetDelay=u.options.saveViewportOffsetDelay||50;u.options.srcset=u.options.srcset||"data-srcset";u.options.src=s=u.options.src||"data-src";w=Element.prototype.closest;p=1<window.devicePixelRatio;i={};i.top=0-u.options.offset;i.left=0-u.options.offset;u.revalidate=function(){h(u)};u.load=function(n,i){var r=this.options;void 0===n.length?l(n,i,r):t(n,function(n){l(n,i,r)})};u.destroy=function(){var i=this._util;this.options.container&&t(this.options.container,function(t){n(t,"scroll",i.validateT)});n(window,"scroll",i.validateT);n(window,"resize",i.validateT);n(window,"resize",i.saveViewportOffsetT);i.count=0;i.elements.length=0;i.destroyed=!0};f.validateT=y(function(){c(u)},u.options.validateDelay,u);f.saveViewportOffsetT=y(function(){v(u.options.offset)},u.options.saveViewportOffsetDelay,u);v(u.options.offset);t(u.options.breakpoints,function(n){if(n.width>=window.screen.width)return s=n.src,!1});setTimeout(function(){h(u)})}});if(getCookie("user_loged_in")=="true"){for(console.log("user_loged_in"),logins=document.getElementsByClassName("login_nav_big"),i=0;i<logins.length;i++)logins[i].innerText=getCookie("login");document.getElementById("add_nav_big").insertAdjacentHTML("afterbegin",`<a href="/Add" class="waves-effect waves-light red lighten-3 btn-small">Add</a>`);document.getElementById("add_nav_small").insertAdjacentHTML("afterbegin",`<li ><a href="/Add">Add</a></li>`);document.getElementById("LoginPage").setAttribute("href","/user/id/14")}else console.log(`user not loged in`);getCookie("viewType")?getCookie("viewType")=="images"?(document.getElementById("changeView1").style.backgroundColor="crimson",d=document.getElementById("changeView1").firstChild,d.style.color="white"):(document.getElementById("changeView3").style.backgroundColor="crimson",d=document.getElementById("changeView3").firstChild,d.style.color="white"):(document.getElementById("changeView2").style.backgroundColor="crimson",d=document.getElementById("changeView2").firstChild,d.style.color="white");getCookie("user_loged_in")!="true"?removePlus():console.log("user logde in");
/*!
